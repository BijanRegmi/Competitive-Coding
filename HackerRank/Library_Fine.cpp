...
int libraryFine(int d1, int m1, int y1, int d2, int m2, int y2) {
    ...
    cout << "D: " << dayslate << " M: " << monthslate << " Y: " << yearslate << endl;
    if (yearslate<0)
        return 0;
    else if (yearslate>0)
        return 10000;
        ...
        if (monthslate>0)
            ...
            if (dayslate>0)
                ...
                return 0;
    // if (dayslate<=0 && monthslate<=0 && yearslate<=0) return 0;
    // else if (monthslate<=0 && yearslate<=0) return 15*dayslate;
    // else if (yearslate<=0) return 500*monthslate;
    // else return 10000;
}
